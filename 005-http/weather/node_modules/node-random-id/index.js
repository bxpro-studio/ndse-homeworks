...
function id(one, two, char){
    return words.adjectives[one]+char+words.nouns[two]
}
...
exports.id = function(one, two, char) {
  return id(one, two, char)
}

exports.ranid = function() {
  return id(ran(adjlen), ran(nounlen), "-")
}
